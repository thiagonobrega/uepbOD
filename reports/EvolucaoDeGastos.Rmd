...
Todos os gráficos foram construidos sobre os valores anuais, ou seja os dados diponibilizados no meu [github](https://github.com/thiagonobrega/uepbOD/tree/master/data) foi consolidado por ano, por isso todos os graficos mostram que 2017 teve um
...
O grafico abaixo ilustra a evolução da folha frente o número de servidores (estatutarios, comissionados, cedidos,...) ao longo dos anos.
