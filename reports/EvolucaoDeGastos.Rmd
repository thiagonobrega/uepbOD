...
Todos os [dados](https://github.com/thiagonobrega/uepbOD/tree/master/data) e o [código fonte](https://github.com/thiagonobrega/uepbOD) para realizar estas analises estão disponiveis no github do projeto. Desse modo fiquem livre para enviar uma correções ou contribuição ;)
...
Em suma, para mim, os dados não demonstraram que o problema que esta na gestão de recurso por parte da Universidade. Percebi alguns fatos que podem ser otimizados, mas por não ser o escopo desse documento não irei tratar aqui.

Dúvidas e Próximas AnálisesO objetivo dessa análise era verificar se o gasto com pessoal estavam sendo mau empregados. Em resumo responder as seguintes perguntas;
...
Todos os dados utilizados são públicos e estão disponíveis no site do portal da transparência da universidade, para mais informações sobre como os dados foram consolidados consultem a documentação do crawler.
